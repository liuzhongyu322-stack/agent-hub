...
本文件只登记 Skill 的名称、位置和适用 Agent。先盘点现状，不在第一阶段复制、改写或统一安装 Skill。

## 当前发现

| Skill | 当前 Agent | 本机位置 | 共享状态 | 备注 |
|---|---|---|---|---|
...
- 新发现的 Skill 先登记，不立即迁移。
- 实际需要跨 Agent 使用时，再判断其说明、脚本和依赖是否可移植。
- 平台内置或平台独占 Skill 保留在原位置。
- 仓库内不得保存 Skill 所使用的密钥、登录信息或本机凭据。
